    ...
    private fun generateDogListData(): List<DogInfo> {
        return listOf(
                ...
                DogInfo(
                        ...
                        "Boston, USA",
                        "The joints of the body are short and wide, the limbs are strong and flexible. The tail is short, not very important, so it is slightly protruding, and the proportion is very important. He gives the impression of being bold, powerful, and active, and his style shows height. The sense of order, the posture is calm and elegant. The joining method and proportion of " color and white " are very distinctive and representative. " Proportionality, expression, color and markings\" are the first details that need to be considered, which determines {Overall appearance} score. The Boston Terrier is one of the few dog breeds bred in the UK. This dog is a smart, lively, and brave small breed. Although there is nothing special, it can be an excellent guard or companion dog. ",
